...
function (gem_DebugDumpVars)
	...
	gem_Msg ("    CMAKE_HOST_SYSTEM_VERSION =    ${CMAKE_HOST_SYSTEM_VERSION}")
	...
	gem_Msg ("")
	gem_Msg ("gem_cmake_params:")
	gem_Msg ("")
	gem_Msg ("    gem_triple =        ${gem_triple}")
	gem_Msg ("    gem_use_clang =     ${gem_use_clang}")
	gem_Msg ("    gem_project_name =  ${gem_project_name}")
	gem_Msg ("")
	...
	gem_Msg ("    CMAKE_HOST_SYSTEM_VERSION =    ${CMAKE_HOST_SYSTEM_VERSION}")
	gem_Msg ("    CMAKE_HOST_SYSTEM_PROCESSOR =  ${CMAKE_HOST_SYSTEM_PROCESSOR}")
	gem_Msg ("    CMAKE_SYSTEM =                 ${CMAKE_SYSTEM}")
	...
	gem_Msg ("    CMAKE_C_COMPILER_ENV_VAR =  ${CMAKE_C_COMPILER_ENV_VAR} Do we need to set this?")
	gem_Msg ("    CMAKE_CXX_COMPILER =        ${CMAKE_CXX_COMPILER}")
	gem_Msg ("    CMAKE_CXX_COMPILER_TARGET = ${gem_triple}")
	gem_Msg ("    CMAKE_CXX_COMPILER_ID =     ${CMAKE_CXX_COMPILER_ID}")
	gem_Msg ("    CMAKE_CXX_COMPILER_ENV_VAR =${CMAKE_CXX_COMPILER_ENV_VAR} Do we need to set this?")
	gem_Msg ("    CMAKE_AR =                  ${CMAKE_AR}")
	gem_Msg ("    CMAKE_LINKER =              ${CMAKE_LINKER}")
	gem_Msg ("    CMAKE_NM =                  ${CMAKE_NM}")
	gem_Msg ("    CMAKE_OBJDUMP =             ${CMAKE_OBJDUMP}")
	gem_Msg ("    CMAKE_RANLIB =              ${CMAKE_RANLIB}")
	gem_Msg ("")
	gem_Msg ("    _CMAKE_TOOLCHAIN_PREFIX =   ${CMAKE_TOOLCHAIN_PREFIX}  Should be \"llmv-\" for clang!")
	gem_Msg ("    _CMAKE_COMPILER_SUFFIX =    ${_CMAKE_COMPILER_SUFFIX}  Should be \"llmv-\" for clang!")
	gem_Msg ("-------------------------------------------------------------------------")
